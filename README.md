...
| 目录 | 当前版本 | 定位 | 维护状态 |
| --- | --- | --- | --- |
| [`UMI-Windows-V4`](UMI-Windows-V4/) | `4.4.0` | 当前 Windows 主版本，使用 UMI V4.0 手动夹爪协议 | 主动维护 |
...
- 左右手视觉与 IMU 相对位姿、可交互三维轨迹、完整闭合动画、相机视锥和稀疏视觉点云。
...
- 最后一个平台页面关闭后自动释放相机、串口和 CAN；异常残留后台由同一个启动入口自动检测和清理。
