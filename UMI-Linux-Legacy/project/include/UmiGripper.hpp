// UmiGripper.hpp - UMI 手动夹爪 V2 驱动（Linux 版）
// 通过 POSIX termios 串口 API 与夹爪 MCU 通信
...
private:
    ...
    int fdSerial_ = -1;          // POSIX file descriptor
    ...
    std::string handSide_;  // "left" or "right"
    bool vidConfirmed_ = false;
