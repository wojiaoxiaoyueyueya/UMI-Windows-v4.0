...
本文面向第一次接触本项目的使用者，也适用于需要换电脑部署、配置设备、录制数据、转换格式和排查故障的开发者。当前对应版本为 `4.2.0`。
...
2. 下载 `UMI-Data-Capture-Platform-4.2.0-Setup.exe`。
3. 右键安装包，选择“以管理员身份运行”。
...
```text
dist/UMI-Data-Capture-Platform-4.2.0-Setup.exe
```
